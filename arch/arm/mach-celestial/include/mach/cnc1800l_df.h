#ifndef __CNC1800L_DF_H__
#define __CNC1800L_DF_H__
...
#define CSDF_IOC_SET_BRIGHTNESS               _IOW(CSDF_IOC_MAGIC, 0x22, int)
#define CSDF_IOC_GET_BRIGHTNESS               _IOR(CSDF_IOC_MAGIC, 0x23, int)
#define CSDF_IOC_SET_CONTRAST                 _IOW(CSDF_IOC_MAGIC, 0x24, int)
#define CSDF_IOC_GET_CONTRAST                 _IOR(CSDF_IOC_MAGIC, 0x25, int)
#define CSDF_IOC_SET_SATURATION               _IOW(CSDF_IOC_MAGIC, 0x26, int)
#define CSDF_IOC_GET_SATURATION               _IOR(CSDF_IOC_MAGIC, 0x27, int)

#define CSDF_IOC_GET_INIT_OUTPUTMODE		  _IOW(CSDF_IOC_MAGIC, 0x28, int)
#define CSDF_IOC_GET_IDCS_DDR_DIV_VAL		  _IOW(CSDF_IOC_MAGIC, 0x29, int)
