#ifndef __CNC1800L_VIDEO_H__
#define __CNC1800L_VIDEO_H__
...
#define MIPS_ISRAM_OFFSET	((0xb1690000 - CSM_VIDEO_REG_BASE) >> 2)
#define MIPS_DSRAM_OFFSET	((0xb16A0000 - CSM_VIDEO_REG_BASE) >> 2)
#define MIPS_RESET_OFFSET	((0xb16B0000 - CSM_VIDEO_REG_BASE) >> 2)
...
#define CSVID_IOC_GET_VIDEO_NUM	_IOW('z', 0x10, int)
// test
#define CSVID_IOC_SET_VIDEO_START		_IOW('z', 0xfe, int)

enum
{
	SDK_FW_IF_PARA_SIZE     = 16*1024,
	DINT_BACK_GROUD_SIZE    = 64*1024,
	DINT_SCALER_COFF_SIZE   = 64*1024,
	ENCODER_TABLE_SIZE      = 2*1024,
	DEC_SWITCH_DATA_SIZE    = 64*1024,
	DINT_SWITCH_DATA_SIZE   = 64*1024,
	ENC_PARA_DATA_SIZE      = 1*1024,
	FW_INTERNAL_DATA_SIZE   = 2*1024,
	COEFF_DDR_DATE_SIZE     = 32*1024,
};
...
enum
{
	...
	ENC_PARA_DATA_OFFSET    = DINT_SWITCH_DATA_OFFSET + DINT_SWITCH_DATA_SIZE,
	FW_INTERNAL_DATA_OFFSET = ENC_PARA_DATA_OFFSET + ENC_PARA_DATA_SIZE,
	COEFF_DDR_DATA_OFFSET   = FW_INTERNAL_DATA_OFFSET + FW_INTERNAL_DATA_SIZE,
};
