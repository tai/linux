...
#define BIT_CSCSEL                       (0x10)

#define VID_ACEN_ADDR                    (0x49)
#define BIT_VID_ACEN_WIDE_BUS_MODE0      (0x00) //8 bits per channle or 24-bit per bus mode
#define BIT_VID_ACEN_WIDE_BUS_MODE1      (0x40) //10 bits per channle or 30-bit per bus mode
#define BIT_VID_ACEN_WIDE_BUS_MODE2      (0x80) //12 bits per channle or 36-bit per bus mode
...
#define TX_VID_BLANK1                    (0x4B)
#define TX_VID_BLANK2                    (0x4C)
#define TX_VID_BLANK3                    (0x4D)
