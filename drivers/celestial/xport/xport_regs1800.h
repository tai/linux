...
#define IN_CHL_BASE_ADDR(n)         ((n)==0?IN_CHL0_BASE_ADDR: IN_CHL1_BASE_ADDR)
#define IN_CHL_CFG_ADDR(n)          ((n)==0?IN_CHL0_CFG_ADDR : IN_CHL1_CFG_ADDR)
#define IN_CHL_RP_ADDR(n)           ((n)==0?IN_CHL0_RP_ADDR  : IN_CHL1_RP_ADDR)
#define IN_CHL_WP_ADDR(n)           ((n)==0?IN_CHL0_WP_ADDR  : IN_CHL1_WP_ADDR)
