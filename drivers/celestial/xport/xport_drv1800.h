...
#define IN_CHL_UNIT_SIZE_DEF(n)    ((n)==0?IN_CHL0_UNIT_SIZE_DEF: IN_CHL1_UNIT_SIZE_DEF)
#define IN_CHL_UNIT_NUM_DEF(n)     ((n)==0?IN_CHL0_UNIT_NUM_DEF: IN_CHL1_UNIT_NUM_DEF)
#define IN_CHL_CFG_DEF(n)          ((n)==0?IN_CHL0_CFG_DEF: IN_CHL1_CFG_DEF)
#define IN_CHL_BASE_DEF(n)         ((n)==0?IN_CHL0_BASE_ADDR_DEF: IN_CHL1_BASE_ADDR_DEF)
#define IN_CHL_BUF_SIZE(n)         ((n)==0?IN_CHL0_BUF_SIZE: IN_CHL1_BUF_SIZE)
...
#define DMA0_BUF0_BASE_ADDR         (IN_CHL1_BASE_ADDR_DEF + IN_CHL1_BUF_SIZE)  //(XPORT_MEM_BASE+0x40000)
...
#define DMA0_LIST0_HEAD_ADDR        (DMA0_BUF1_BASE_ADDR + DMA0_BUF1_SIZE)  //(XPORT_MEM_BASE+0x80000)
#define DMA0_LIST1_HEAD_ADDR        (DMA0_LIST0_HEAD_ADDR + DMA_LIST_HEAD_SIZE)    //(XPORT_MEM_BASE+0x80800)

#define MIPS_EXTERNAL_BASE_ADDR     (DMA0_LIST1_HEAD_ADDR + DMA_LIST_HEAD_SIZE)    // size = 0xE000
